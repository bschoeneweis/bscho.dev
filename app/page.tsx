...
export default function Home() {
  return (
    <>
      ...
      <p className={styles.bioParagraph}>I&apos;m a staff engineer at <InlineLink href='https://radar.com'>Radar</InlineLink> working remotely in <InlineLink href='https://radar.com/demo/maps#13/32.754542065879974/-97.33142386594159'>Fort Worth, TX</InlineLink>.</p>
